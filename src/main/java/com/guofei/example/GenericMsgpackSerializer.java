...
/**
 * @author: GuoFei
 * @date: 2022-03-09 19:49
 */
public class GenericMsgpackSerializer implements Serializable {

  static final byte[] EMPTY_ARRAY = new byte[0];
  private final ObjectMapper mapper;

  public GenericMsgpackSerializer(ObjectMapper mapper) {
    this.mapper = new ObjectMapper(new MessagePackFactory());
    this.mapper.registerModule((new SimpleModule()).addSerializer(new GenericMsgpackSerializer.NullValueSerializer(null)));
